...
# Disable parallel execution and coverage for benchmarks
# They interfere with accurate timing measurements
PYTEST_CMD="uv run pytest -m performance -o addopts='-v'"
